...
class ListPageVocabulary extends StatelessWidget {
  final String title;
  final String level;
  final Map<String, dynamic> data;

  const ListPageVocabulary({
    super.key,
    required this.title,
    required this.level,
    required this.data,
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: FutureBuilder<List<Map<String, dynamic>?>>(
          future: _fetchAllVocabularies(vocabularyService),
  ...
  Future<List<Map<String, dynamic>?>> _fetchAllVocabularies(
      VocabularyService service) async {
    return await Future.wait(
      data.keys.map((key) => service.getVocabularyById(key)),
    );
  }
}
