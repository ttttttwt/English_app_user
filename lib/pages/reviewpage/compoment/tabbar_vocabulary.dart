...
class TabbarVocabulary extends StatelessWidget {
  final Map<String, dynamic> vocabularyData;
  final Function(String, Map<String, dynamic>) onTotalVocabularyCardTap;

  const TabbarVocabulary({
    super.key,
    required this.vocabularyData,
    required this.onTotalVocabularyCardTap,
  });

  @override
  Widget build(BuildContext context) {
    final VocabularyService vocabularyService = VocabularyService();
    final basic = getVocabularyByMemoryLevel('Basic', vocabularyData);
    final intermediate =
        getVocabularyByMemoryLevel('Intermediate', vocabularyData);
    final advanced = getVocabularyByMemoryLevel('Advanced', vocabularyData);
    final expert = getVocabularyByMemoryLevel('Expert', vocabularyData);
          ...
          children: [
            Expanded(
              child: TotalVocabularyCard(
                ...
                onTap: () => onTotalVocabularyCardTap('Basic', basic),
              ),
            ),
            Expanded(
              child: TotalVocabularyCard(
                ...
                tabContainerPadding: tabContainerPadding,
                onTap: () =>
                    onTotalVocabularyCardTap('Intermediate', intermediate),
              ),
            ),
          ],
        ),
          ...
          children: [
            Expanded(
              child: TotalVocabularyCard(
                ...
                tabContainerMargin: tabContainerMargin,
                tabContainerPadding: tabContainerPadding,
                onTap: () => onTotalVocabularyCardTap('Advanced', advanced),
                vocabularyData: vocabularyData,
              ),
            ),
            Expanded(
              child: TotalVocabularyCard(
                ...
                tabContainerMargin: tabContainerMargin,
                tabContainerPadding: tabContainerPadding,
                onTap: () => onTotalVocabularyCardTap('Expert', expert),
                vocabularyData: vocabularyData,
              ),
            ),
          ],
          ...
          child: Padding(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                final key = vocabularyData.keys.elementAt(index);
                final vocabData = vocabularyData[key];
                ...
                return FutureBuilder<Map<String, dynamic>?>(
                  future: vocabularyService.getVocabularyById(key),
                    ...
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      return Padding(
                        ...
                        child: VocabularyCard(
                          ...
                          englishWord: 'Deleted Vocabulary',
                          vietnameseWord: 'This vocabulary item has been deleted',
                          level: level,
                          onTap: () {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text('This vocabulary item is no longer available'),
                    ...
                    return Padding(
                      ...
                      child: VocabularyCard(
                        imageUrl: vocab['imageUrl'] ??
                            'https://images.squarespace-cdn.com/content/v1/61c4da8eb1b30a201b9669f2/e2e0e62f-0064-4f86-b9d8-5a55cb7110ca/Korembi-January-2024.jpg',
                        englishWord: vocab['englishWord'] ?? 'Word',
                        vietnameseWord: vocab['vietnameseWord'] ?? 'Từ',
                        level: level,
                        onTap: () => onTap(
                          context,
                          vocab['englishWord'] ?? 'Word',
                          vocab['vietnameseWord'] ?? 'Từ',
